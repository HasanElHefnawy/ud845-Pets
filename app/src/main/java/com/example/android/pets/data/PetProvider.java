...
public class PetProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues contentValues) {
        ...
        switch (match) {
//            case PETS not PET_ID because the new pet doesn't have an ID yet.
            case PETS:
...
//        if (name == null || name.isEmpty()) {
        if (TextUtils.isEmpty(name)) {  // returns true if the input String is null or empty
            throw new IllegalArgumentException("Pet requires a name");
        }
    }

    private void checkWeight(ContentValues values) {
    ...
    private void checkBreed(ContentValues values){
    ...
    private void checkGender(ContentValues values){
